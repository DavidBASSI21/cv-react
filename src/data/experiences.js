export default [
  {
    id: 1,
    title: 'Développeur Web Front-End - React',
    location: 'École O’Clock - Projet de fin de formation',
    date: '06 mai 2024 - 06 juin 2024',
    description:
      'Réalisation d’une application web en équipe de 4 personnes, de sa <strong>conception jusqu’au déploiement</strong> d’un MVP en méthode <strong>Agile</strong>. Rôle occupé : <strong>développeur front-end et Scrum-Master</strong>.',
  },
  {
    id: 2,
  ...
  {
    id: 3,
    title: 'Réceptionniste, Responsable Hébergement, Adjoint de Direction',
